...
--
-- Name: insurance; Type: TABLE; Schema: public; Owner: flotte
--
...
ALTER TABLE public.insurance OWNER TO flotte;

--
-- Name: insurance_id_seq; Type: SEQUENCE; Schema: public; Owner: flotte
--
...
ALTER TABLE public.insurance_id_seq OWNER TO flotte;

--
-- Name: insurance_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: flotte
--
...
--
-- Name: insurance id; Type: DEFAULT; Schema: public; Owner: flotte
--
...
--
-- Data for Name: insurance; Type: TABLE DATA; Schema: public; Owner: flotte
--

COPY public.insurance (id, vehicle_id, start_date, end_date) FROM stdin;
\.
...
32	9007a22d60a57cc66393a92c98ef112aa03713b1	1	2022-12-13 10:48:54.753503+03
\.
...
--
-- Name: insurance_id_seq; Type: SEQUENCE SET; Schema: public; Owner: flotte
--
...
--
-- Name: insurance insurance_pkey; Type: CONSTRAINT; Schema: public; Owner: flotte
--
...
--
-- Name: insurance insurance_vehicle_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: flotte
--

ALTER TABLE ONLY public.insurance
    ADD CONSTRAINT insurance_vehicle_id_fkey FOREIGN KEY (vehicle_id) REFERENCES public.vehicle(id);
